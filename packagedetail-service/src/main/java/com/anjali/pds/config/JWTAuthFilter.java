...
public class JWTAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authHeader == null || !authHeader.startsWith("Bearer ")) {
            System.out.println("No token found! - This is PDS.");
        ...
        if (userName != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (JWTService.validateToken(jwtToken) && JWTService.getUserRole(jwtToken).equals("PAYA") || JWTService.getUserRole(jwtToken).equals("PDA") || JWTService.getUserRole(jwtToken).equals("UA") || JWTService.getUserRole(jwtToken).equals("USER") || JWTService.getUserRole(jwtToken).equals("HA") || JWTService.getUserRole(jwtToken).equals("VA") || JWTService.getUserRole(jwtToken).equals("GA") || JWTService.getUserRole(jwtToken).equals("PA")) {
